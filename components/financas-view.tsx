...
export default function FinancasView({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Limpar formulário após adicionar ou editar transação
    resetarFormulario()
  }
  ...
  const handleEditTransacao = (id: string, transacao: Transacao) => {
    // Remover o id original do objeto transacao e definir o novo id
    const { id: _, ...transacaoSemId } = transacao
    setTransacaoParaEditar({ ...transacaoSemId, id })
    setTipo(transacao.tipo)
    setDescricao(transacao.descricao)
